...
using MultiTenant_ForgotPassword.Module.Security;

namespace MultiTenant_ForgotPassword.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class MultiTenant_ForgotPasswordModule : ModuleBase {
    public MultiTenant_ForgotPasswordModule() {
		// 
		// MultiTenant_ForgotPasswordModule
		// 
