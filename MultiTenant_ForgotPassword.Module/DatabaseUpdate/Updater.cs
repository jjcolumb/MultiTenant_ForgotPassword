...
namespace MultiTenant_ForgotPassword.Module.DatabaseUpdate;
...
#if !RELEASE
        if (TenantName == null) {
            _ = CreateTenant("company1.com", "MultiTenant_ForgotPassword_company1");
            _ = CreateTenant("company2.com", "MultiTenant_ForgotPassword_company2");
